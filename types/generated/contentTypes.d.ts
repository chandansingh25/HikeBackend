...
export interface ApiCategorieCategorie extends Schema.CollectionType {
  ...
  attributes: {
    slug: Attribute.UID;
    SubHeading: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiExpertExpert extends Schema.CollectionType {
  ...
  attributes: {
    ...
    WorkingAt_Name: Attribute.String;
    Education: Attribute.Component<'education.education', true>;
    LanguageSpoken: Attribute.Component<'language.language-spoken', true>;
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    BannerSubHeading: Attribute.String &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        maxLength: 25;
      }> &
      Attribute.DefaultTo<'Guide With'>;
    BannerMainHeading: Attribute.String & Attribute.Required;
    ...
    ExpertSectionHeading: Attribute.String & Attribute.Required;
    ExpertSubHeading: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
